...
-   [IMPORTANT - THIS SNIPPET IS PLACED INIT.EL](#org64aae8c)
-   [ABOUT THIS CONFIG](#org9e3155b)
-   [A FEW PROGRAMS TO RUN FIRST](#orgab05865)
    -   [Setup Package.el to work with MELPA](#org316d7cd)
    -   [Use-Packaged](#orgb3b4dfd)
    -   [Move auto-save files and backups](#orga69f0be)
    -   [Evil Mode](#orgccb749c)
    -   [Persistent Scratch](#org0c93056)
    -   [General Keybindings](#org72550af)
-   [START-UP PERFORMANCE](#orgccd3827)
    -   [Garbage Collection](#orga20cfb6)
    -   [Native Compile](#orgbaf70e5)
-   [ALL-THE-ICONS](#org21b3388)
-   [BUFFERS AND BOOKMARKS](#orgc8ecb1b)
-   [EMACS DASHBOARD](#orgae6b6cb)
-   [EVALUATE ELISP EXPRESSIONS](#org88610b7)
-   [EVALUATE E(LISP) EXPRESSIONS](#orgb1d61b4)
-   [FILES](#orgf2955dc)
-   [FONTS](#orgdabd0c5)
    -   [Use Greek Letters](#orgbc693a7)
    -   [Zooming In and Out](#orge218f89)
-   [GENERAL KEYBINDINGS](#org1f3f2f3)
-   [AGENDA MODE KEYBINDINGS (OLD)](#org5d3f915)
-   [ESC KEY REMAPPING](#org700e06a)
    -   [Old Version, Disabled](#org6e01877)
    -   [Working Version With Key-Chords](#orge86346c)
-   [LANGUAGE SUPPORT](#org5bb6d0a)
-   [GRAPHICAL USER INTERFACE TWEAKS](#org39c06eb)
    -   [Disable Menubar, Toolbars and Scrollbars](#orgd280b60)
    -   [Disable Splash Screen](#org8a9500f)
    -   [Display Line Numbers and Truncated Lines](#org8132c86)
    -   [Change Modeline To Doom's Modeline](#orgfee7093)
    -   [Shift Focus to Help Window](#orgeb66135)
-   [ORG MODE](#org639d2b1)
    -   [Defining Some Things](#orgac26e96)
    -   [Enabling Org Bullets](#orgb8f8000)
    -   [Source-Code Block Syntax Highlighting](#orgdba8851)
    -   [Clean M-Ret Insertions](#orge444627)
-   [PROJECTILE](#orgec80edf)
-   [SCROLLING](#org751fded)
-   [SHELLS & REPLS](#org1992b8f)
    -   [Eshell](#org4af431c)
    -   [SLIME](#org869c6ca)
    -   [Tramp](#org685f51f)
-   [THEME](#org9390119)
    -   [DOOM theme](#orga9fb413)
    -   [Lisp Syntax Guidance](#org33dcb6c)
-   [RUNTIME PERFORMANCE](#org65edf88)
-   [DARKROOM MODE](#orgb19d61d)
-   [MISCELANEOUS, MISSING](#org6ad98f6)
...
;; Note that my agenda files are set elsewhere for now
(setq org-directory (expand-file-name "~/org/")
      org-agenda-files '("~/org/agenda.org")
      org-default-notes-file (expand-file-name "my-notes.org" org-directory)
      org-ellipsis " ▼ "
      org-log-done 'time 

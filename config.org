...
(nvmap :prefix "SPC"
       ...
       "o f"   '((lambda () (interactive) (find-file "~/org/fun.org")) :which-key "Fun/Hobbies")
       ...
       "o d"   '((lambda () (interactive) (find-file "~/org/agenda.org")) :which-key "Daily Habits (Agenda)") ; "daily" is awkward
...
Dabbrev (built-in) for now, then maybe ctags or lsp
...
(use-package company
  ...
  :config
  ;; (global-company-mode)
  (setq company-backends '((company-capf company-dabbrev-code slime-company)))

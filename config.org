...
-   [[#important-message][IMPORTANT - THIS SNIPPET IS PLACED INIT.EL]]
-   [[#about-config][ABOUT THIS CONFIG]]
-   [[#run-first][A FEW PROGRAMS TO RUN FIRST]]
    -   [[#setup-packagel][Setup Package.el to work with MELPA]]
    -   [[#use-packaged][Use-Packaged]]
    -   [[#move-auto-save][Move auto-save files and backups]]
    -   [[#evil-mode][Evil Mode]]
    -   [[#persistent-scratch][Persistent Scratch]]
    -   [[#general-keybindings][General Keybindings]]
-   [[#start-up-performance][START-UP PERFORMANCE]]
...
-   [[#files][FILES]]
-   [[#fonts][FONTS]]
    -   [[#use-greek-letters][Use Greek Letters]]
    -   [[#zooming-in-and-out][Zooming In and Out]]
-   [[#general-keybindings-2][GENERAL KEYBINDINGS]]
-   [[#esc-key-remapping][ESC KEY REMAPPING]]
    -   [[#old-version-disabled][Old Version, Disabled]]
    -   [[#working-version-with-key-chords][Working Version With Key-Chords]]
-   [[#language-support][LANGUAGE SUPPORT]]
-   [[#graphical-user-interface-tweaks][GRAPHICAL USER INTERFACE TWEAKS]]
    -   [[#disable-menubar-toolbars-and-scrollbar][Disable Menubar, Toolbars and Scrollbars]]
    -   [[disable-splash-screen][Disable Splash Screen]]
    -   [[#display-line-numbers-and-trunc][Display Line Numbers and Truncated Lines]]
    -   [[#change-modeline-to-dooms-modeline][Change Modeline To Doom's Modeline]]
    -   [[#shift-focus-to-help-window][Shift Focus to Help Window]]
-   [[#org-mode][ORG MODE]]
    ...
    -   [[#clean-m-ret-insertions][Clean M-Ret Insertions]]
-   [[#projectile][PROJECTILE]]
-   [[#scrolling][SCROLLING]]
-   [[#shells-and-repls][SHELLS & REPLS]]
    -   [[#eshell][Eshell]]
    -   [[#slime][SLIME]]
    -   [[#tramp][Tramp]]
-   [[#theme][THEME]]
    -   [[#doom-theme][DOOM theme]]
    -   [[#lisp-syntax-guidance][Lisp Syntax Guidance]]
-   [[#runtime-performance][RUNTIME PERFORMANCE]]
-   [[#darkroom-mode][DARKROOM MODE]]
-   [[#miscelaneous-missing][MISCELANEOUS, MISSING]]
